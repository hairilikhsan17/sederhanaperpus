...
<div class="container mt-5">
    <h1 class="text-center mb-4">Filter Data Peminjaman</h1>

    <!-- Form Filter -->
    <form action="{{ route('admin.peminjaman.filter') }}" method="GET" class="mb-4">
        <div class="row">
        ...
        <a href="{{ route('admin.peminjaman.filter') }}" class="btn btn-secondary">Reset</a>
    </form>
